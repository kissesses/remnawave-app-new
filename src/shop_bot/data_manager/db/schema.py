...
def _ensure_webapp_settings_table(cursor: sqlite3.Cursor):
    try:
        ...
        if "webapp_enabled_designs" not in columns:
            cursor.execute(
                "ALTER TABLE webapp_settings ADD COLUMN webapp_enabled_designs TEXT DEFAULT 'classic,ios,desktop,stealth,stealth-glass,glass-hub,nova,pref-classic,pref-macos,pref-macos-v2,pref-glass-stealth'"
            )
...
def _ensure_webapp_design_columns(cursor) -> None:
    ...
    _ensure_table_column(
        ...
        "TEXT DEFAULT 'classic,ios,desktop,stealth,stealth-glass,glass-hub,nova,pref-classic,pref-macos,pref-macos-v2,pref-glass-stealth'",
    )
